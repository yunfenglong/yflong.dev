...
export default function StatusPage() {
  return (
    <div className="min-h-screen text-white font-mono overflow-hidden relative">
      ...
      {/* Main Content */}
      <motion.div
        className="relative z-20 min-h-screen p-4 sm:p-6 lg:p-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="fixed inset-0 z-30 pointer-events-none">
        <nav aria-label="global navigation" className="absolute top-0 left-0 right-0 z-10 pointer-events-auto">
          v1.0.0
